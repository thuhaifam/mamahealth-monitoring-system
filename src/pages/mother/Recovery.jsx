  ...
  return (
    <div className="container-fluid">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
          <h1 className="h3 text-white mb-0" style={{ fontFamily: "Outfit" }}>
            Daily Recovery Logs
          </h1>
          <span className="text-muted small">
            Record and monitor your daily recovery indicators
          </span>
        </div>
        <button
      ...
      <div className="premium-card">
        <h3 className="h5 text-white mb-4" style={{ fontFamily: "Outfit" }}>
          Logged History
        </h3>
        ...
        {history.length > 0 ? (
              ...
              <tbody>
                {history.map((record) => (
                  <tr key={record.id}>
                    ...
                    <td>
                      <span
                        className={`badge ${record.painLevel > 6 ? "bg-danger" : record.painLevel > 3 ? "bg-warning text-dark" : "bg-success"}`}
                      >
                        {record.painLevel} / 10
                      </span>
                    </td>
                    ...
                    <td>
                      <span
                        className={`badge ${record.woundCondition === "NORMAL" ? "bg-success" : "bg-danger"}`}
                      >
          ...
          <div className="text-center text-muted py-5">
            ...
            <p className="small">
              Please log your daily state to track metrics over time.
            </p>
          </div>
        )}
      </div>
