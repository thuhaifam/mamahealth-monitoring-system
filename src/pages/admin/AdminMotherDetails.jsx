...
import { FaUser, FaHeartbeat, FaPills, FaCalendar, FaArrowLeft, FaCheck, FaTimes, FaFileAlt } from 'react-icons/fa'
import API from '../../api.js'

const AdminMotherDetails = () => {
  const { id } = useParams()
  ...
  const fetchData = async () => {
    try {
      ...
      try {
        ...
        console.log('Error fetching recovery records', err)
      }
  ...
  return (
    <div className="container-fluid">
      ...
      <div className="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
          <h1 className="h3 text-white mb-0" style={{ fontFamily: 'Outfit' }}>Auditing Mother File: {mother?.fullName}</h1>
      ...
      <div className="row g-4">
        <div className="col-12">
          ...
          {activeTab === 'meds' && (
            <div className="premium-card">
              <h3 className="h6 text-white mb-3" style={{ fontFamily: 'Outfit' }}>Prescribed Medications</h3>
              {meds.length > 0 ? (
                <div className="table-responsive">
                  <table className="table table-custom mb-0">
                    <thead>
          ...
          {activeTab === 'appts' && (
            <div className="premium-card">
              <h3 className="h6 text-white mb-3" style={{ fontFamily: 'Outfit' }}>Scheduled Appointments</h3>
              {appts.length > 0 ? (
                <div className="table-responsive">
                  <table className="table table-custom mb-0">
                    <thead>
                ...
                <div className="text-center text-muted py-5">
                  <FaCalendar size={48} className="opacity-20 mb-3" />
...
export default AdminMotherDetails
